export default {
  ...
  服务状态: ["Service status", "Состояние службы"],
  正在执行: ["Running", "Выполняется"],
  操作失败: ["Operation failed", "Операция не выполнена"],
  操作完成: ["Operation complete", "Операция завершена"],
  热点代理帮助: ["Hotspot proxy help", "Справка по прокси точки доступа"],
  "CPU 占用": ["CPU usage", "Использование CPU"],
  "内存占用（RSS）": ["Memory usage (RSS)", "Использование памяти (RSS)"],
  暂不可用: ["Unavailable", "Недоступно"],
  指定网络直连: ["Selected networks direct", "Выбранные сети напрямую"],
  指定网络代理: ["Selected networks proxied", "Выбранные сети через прокси"],
  指定网络列表: ["Selected networks", "Выбранные сети"],
  "列表中的网络直连，其余网络走代理。": ["Listed networks use direct; all others use the proxy.", "Сети в списке используют прямое подключение, остальные — прокси."],
  "列表中的网络走代理，其余网络直连。": ["Listed networks use the proxy; all others use direct.", "Сети в списке используют прокси, остальные — прямое подключение."],
  当前连接: ["Current connection", "Текущее подключение"],
  未连接: ["Not connected", "Не подключено"],
  "输入 SSID": ["Enter SSID", "Введите SSID"],
  "输入 BSSID": ["Enter BSSID", "Введите BSSID"],
  "添加当前 Wi-Fi": ["Add current Wi-Fi", "Добавить текущую сеть Wi-Fi"],
  类型: ["Type", "Тип"],
  规则值: ["Rule value", "Значение правила"],
  操作: ["Actions", "Действия"],
  编辑规则: ["Edit rule", "Изменить правило"],
  删除规则: ["Delete rule", "Удалить правило"],
  保存: ["Save", "Сохранить"],
  "暂无 Wi-Fi 规则": ["No Wi-Fi rules", "Правил Wi-Fi пока нет"],
